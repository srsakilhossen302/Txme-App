...
import 'ScheduleBookingPage.dart';
...
class AppointmentsPage extends StatelessWidget {
  ...
  Widget buildCard(appointment, BuildContext context) {
  ...
  Widget buildSection(String title, String type, BuildContext context) {
    return Obx(() {
      final items = controller.filter(type);
      ...
      return Column(
        ...
        children: [
          ...
          ...items.map((e) => buildCard(e, context)).toList(),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            buildSection("Pending", "pending", context),
            buildSection("Confirmed", "confirmed", context),
            buildSection("Cancelled", "cancelled", context),
          ],
        ),
      ),
    );
