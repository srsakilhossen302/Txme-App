...
class Uploaddocuments1 extends StatefulWidget {
  const Uploaddocuments1({super.key});

  @override
  State<Uploaddocuments1> createState() => _Uploaddocuments1State();
}

class _Uploaddocuments1State extends State<Uploaddocuments1> {
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(top: 11.w, right: 130.w),
              child: Text(
                AppString.UploadPassportBack.tr,
                style: TextStyle(
                  color: AppColors.black700,
                  fontSize: 14.sp,  // Use ScreenUtil for font size
                  fontWeight: FontWeight.w500,
            ...
            // Passport Back Upload Button (Camera Icon)
            GestureDetector(
              onTap: () {
                if (_isCameraInitialized) {
                  _takePicture();  // Trigger camera to take a picture
