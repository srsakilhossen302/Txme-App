...
class FaceIDSetupScreen2 extends StatefulWidget {
  const FaceIDSetupScreen2({super.key});

  @override
  State<FaceIDSetupScreen2> createState() => _FaceIDSetupScreen2State();
}

class _FaceIDSetupScreen2State extends State<FaceIDSetupScreen2> {
            ...
            child: CustomButton(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8.w),
                  Text(
                    AppString.authenticateFaceID.tr,
                    style: TextStyle(
                      color: AppColors.FFFFFF,
                      fontSize: 16.sp,
              ...
              onTap: () {
                Get.toNamed(AppRoute.signupdone);
              },
            ),
          ),
        ],
